(function (global, factory) {
	...
	function requireContext() {
	  ...
	  var Context$1 = /*#__PURE__*/function () {
	    ...
	    return _createClass(Context, [{
	      ...
	      key: "ellipse",
	      value: function ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, counterclockwise) {
	  ...
	  var Node$1 = /*#__PURE__*/function () {
	    ...
	    return _createClass(Node, [{
	      ...
	      value: function cache(config) {
	        ...
	        var extraPaddingX = Math.abs(Math.round(rect.x) - x) > 0.5 ? 1 : 0;
	        var extraPaddingY = Math.abs(Math.round(rect.y) - y) > 0.5 ? 1 : 0;
	            ...
	            try {
	              ...
	              for (n = 0; n < len; n++) {
	                ...
	                if (typeof filter !== 'function') {
	                  Util_1.Util.error('Filter should be type of function, but got ' + _typeof$1(filter) + ' instead. Please check correct filters');
	                  continue;
	                }
	...
	function requireContainer() {
	  ...
	  var Validators_1 = requireValidators();
	  var Container$1 = /*#__PURE__*/function (_Node_1$Node) {
	    function Container() {
	      var _this;
	    ...
	    return _createClass(Container, [{
	      ...
	      value: function _clearSelfAndDescendantCache(attr) {
	        var _a;
	        _superPropGet(Container, "_clearSelfAndDescendantCache", this, 3)([attr]);
	        if (this.isCached()) {
	          return;
	        }
	  ...
	  Factory_1.Factory.addComponentsGetterSetter(Container$1, 'clip', ['x', 'y', 'width', 'height']);
	  ...
	  (function (exports) {
	        ...
	        value: function _pointerdown(evt) {
	          ...
	          this._changedPointerPositions.forEach(function (pos) {
	            ...
	            if (!shape || !shape.isListening()) {
	              _this3[eventType + 'ClickStartShape'] = undefined;
	              return;
	            }
	        ...
	        value: function _pointermove(evt) {
	          ...
	          this._changedPointerPositions.forEach(function (pos) {
	            ...
	            if (differentTarget && targetShape) {
	              targetShape._fireAndBubble(events.pointerout, _objectSpread2({}, event), shape);
	              targetShape._fireAndBubble(events.pointerleave, _objectSpread2({}, event), shape);
	            }
	            if (shape) {
	            ...
	            if (shape && shape.isListening()) {
	              triggeredOnShape = true;
	              if (differentTarget) {
	                shape._fireAndBubble(events.pointerover, _objectSpread2({}, event), targetShape);
	                shape._fireAndBubble(events.pointerenter, _objectSpread2({}, event), targetShape);
	                _this4[eventType + 'targetShape'] = shape;
	              }
	              shape._fireAndBubble(events.pointermove, _objectSpread2({}, event));
	            } else {
	              if (targetShape) {
	        ...
	        value: function _pointerup(evt) {
	          ...
	          this._changedPointerPositions.forEach(function (pos) {
	            ...
	            if (shape && shape.isListening()) {
	              ...
	              shape._fireAndBubble(events.pointerup, _objectSpread2({}, event));
	              if (Global_1.Konva['_' + eventType + 'ListenClick'] && clickStartShape && clickStartShape === shape) {
	                shape._fireAndBubble(events.pointerclick, _objectSpread2({}, event));
	                if (fireDblClick && clickEndShape && clickEndShape === shape) {
	                  shape._fireAndBubble(events.pointerdblclick, _objectSpread2({}, event));
	                }
	              }
	            } else {
	    ...
	    if (Global_1.Konva.isBrowser) {
	      document.addEventListener('visibilitychange', function () {
	        exports.stages.forEach(function (stage) {
	          stage.batchDraw();
	        });
	      });
	    }
	    ...
	    var Shape = /*#__PURE__*/function (_Node_1$Node) {
	      ...
	      return _createClass(Shape, [{
	        ...
	        value: function intersects(point) {
	          ...
	          var p = bufferHitCanvas.context.getImageData(Math.round(point.x), Math.round(point.y), 1, 1).data;
	          return p[3] > 0;
	        }
	      }, {
	        key: "destroy",
	        ...
	        value: function getClientRect() {
	          ...
	          var skipTransform = config.skipTransform;
	          var relativeTo = config.relativeTo || hasCachedParent && this.getStage() || undefined;
	        ...
	        value: function drawHitFromCache() {
	          ...
	          try {
	            var hitImageData = hitContext.getImageData(0, 0, hitWidth, hitHeight);
	...
	function requireLayer() {
	  ...
	  var Layer$1 = /*#__PURE__*/function (_Container_1$Containe) {
	  ...
	  Factory_1.Factory.addGetterSetter(Layer$1, 'hitGraphEnabled', true, (0, Validators_1.getBooleanValidator)());
	  return Layer;
	}
	...
	function requireFastLayer() {
	  ...
	  var Global_1 = requireGlobal();
	  var FastLayer$1 = /*#__PURE__*/function (_Layer_1$Layer) {
	...
	function requireGroup() {
	  ...
	  var Container_1 = requireContainer();
	  var Global_1 = requireGlobal();
	  var Group$1 = /*#__PURE__*/function (_Container_1$Containe) {
	    function Group() {
	...
	function requireLine() {
	  ...
	  function expandPoints(p, tension) {
	    ...
	    for (var n = 2; n < len - 2; n += 2) {
	      var cp = getControlPoints(p[n - 2], p[n - 1], p[n], p[n + 1], p[n + 2], p[n + 3], tension);
	      if (isNaN(cp[0])) {
	        continue;
	      }
	      allPoints.push(cp[0]);
	  ...
	  var Line$1 = /*#__PURE__*/function (_Shape_1$Shape) {
	  ...
	  Factory_1.Factory.addGetterSetter(Line$1, 'tension', 0, (0, Validators_1.getNumberValidator)());
	  Factory_1.Factory.addGetterSetter(Line$1, 'points', [], (0, Validators_1.getNumberArrayValidator)());
	  return Line;
	}
	...
	function requireRect() {
	  ...
	  var Util_1 = requireUtil();
	  var Validators_1 = requireValidators();
	  var Rect$1 = /*#__PURE__*/function (_Shape_1$Shape) {
	    function Rect() {
	  ...
	  Factory_1.Factory.addGetterSetter(Rect$1, 'cornerRadius', 0, (0, Validators_1.getNumberOrArrayOfNumbersValidator)(4));
	  return Rect;
	}
	...
	function requireText() {
	  ...
	  function stringToArray(string) {
	    return _toConsumableArray(string).reduce(function (acc, char, index, array) {
	      if (/(?:[#\*0-9\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23E9-\u23F3\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB-\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u261D\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692-\u2697\u2699\u269B\u269C\u26A0\u26A1\u26A7\u26AA\u26AB\u26B0\u26B1\u26BD\u26BE\u26C4\u26C5\u26C8\u26CE\u26CF\u26D1\u26D3\u26D4\u26E9\u26EA\u26F0-\u26F5\u26F7-\u26FA\u26FD\u2702\u2705\u2708-\u270D\u270F\u2712\u2714\u2716\u271D\u2721\u2728\u2733\u2734\u2744\u2747\u274C\u274E\u2753-\u2755\u2757\u2763\u2764\u2795-\u2797\u27A1\u27B0\u27BF\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B50\u2B55\u3030\u303D\u3297\u3299]|\uD83C[\uDC04\uDCCF\uDD70\uDD71\uDD7E\uDD7F\uDD8E\uDD91-\uDD9A\uDDE6-\uDDFF\uDE01\uDE02\uDE1A\uDE2F\uDE32-\uDE3A\uDE50\uDE51\uDF00-\uDF21\uDF24-\uDF93\uDF96\uDF97\uDF99-\uDF9B\uDF9E-\uDFF0\uDFF3-\uDFF5\uDFF7-\uDFFF]|\uD83D[\uDC00-\uDCFD\uDCFF-\uDD3D\uDD49-\uDD4E\uDD50-\uDD67\uDD6F\uDD70\uDD73-\uDD7A\uDD87\uDD8A-\uDD8D\uDD90\uDD95\uDD96\uDDA4\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA-\uDE4F\uDE80-\uDEC5\uDECB-\uDED2\uDED5-\uDED7\uDEDC-\uDEE5\uDEE9\uDEEB\uDEEC\uDEF0\uDEF3-\uDEFC\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDD0C-\uDD3A\uDD3C-\uDD45\uDD47-\uDDFF\uDE70-\uDE7C\uDE80-\uDE89\uDE8F-\uDEC6\uDECE-\uDEDC\uDEDF-\uDEE9\uDEF0-\uDEF8])/.test(char)) {
	      ...
	      } else if (/(?:\uD83C[\uDDE6-\uDDFF]){2}/.test(char + (array[index + 1] || ''))) {
	        acc.push(char + array[index + 1]);
	      } else if (index > 0 && /(?:[\u0300-\u036F\u0483-\u0487\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u0897-\u089F\u08CA-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09C1-\u09C4\u09CD\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B
uA9BA\uA9BB\uA9BE-\uA9C0\uAA2F\uAA30\uAA33\uAA34\uAA4D\uAA7B\uAA7D\uAAEB\uAAEE\uAAEF\uAAF5\uABE3\uABE4\uABE6\uABE7\uABE9\uABEA\uABEC]|\uD804[\uDC00\uDC02\uDC82\uDCB0-\uDCB2\uDCB7\uDCB8\uDD2C\uDD45\uDD46\uDD82\uDDB3-\uDDB5\uDDBF\uDDC0\uDDCE\uDE2C-\uDE2E\uDE32\uDE33\uDE35\uDEE0-\uDEE2\uDF02\uDF03\uDF3E\uDF3F\uDF41-\uDF44\uDF47\uDF48\uDF4B-\uDF4D\uDF57\uDF62\uDF63\uDFB8-\uDFBA\uDFC2\uDFC5\uDFC7-\uDFCA\uDFCC\uDFCD\uDFCF]|\uD805[\uDC35-\uDC37\uDC40\uDC41\uDC45\uDCB0-\uDCB2\uDCB9\uDCBB-\uDCBE\uDCC1\uDDAF-\uDDB1\uDDB8-\uDDBB\uDDBE\uDE30-\uDE32\uDE3B\uDE3C\uDE3E\uDEAC\uDEAE\uDEAF\uDEB6\uDF1E\uDF20\uDF21\uDF26]|\uD806[\uDC2C-\uDC2E\uDC38\uDD30-\uDD35\uDD37\uDD38\uDD3D\uDD40\uDD42\uDDD1-\uDDD3\uDDDC-\uDDDF\uDDE4\uDE39\uDE57\uDE58\uDE97]|\uD807[\uDC2F\uDC3E\uDCA9\uDCB1\uDCB4\uDD8A-\uDD8E\uDD93\uDD94\uDD96\uDEF5\uDEF6\uDF03\uDF34\uDF35\uDF3E\uDF3F\uDF41]|\uD818[\uDD2A-\uDD2C]|\uD81B[\uDF51-\uDF87\uDFF0\uDFF1]|\uD834[\uDD65\uDD66\uDD6D-\uDD72])/.test(char)) {
	  ...
	  var Text$1 = /*#__PURE__*/function (_Shape_1$Shape) {
	    ...
	    return _createClass(Text, [{
	      ...
	      value: function _sceneFunc(context) {
	        ...
	        for (n = 0; n < textArrLen; n++) {
	          ...
	          if (shouldUnderline) {
	            context.save();
	            context.beginPath();
	            var yOffset = Global_1.Konva._fixTextRendering ? Math.round(fontSize / 4) : Math.round(fontSize / 2);
	          ...
	          if (direction !== RTL && (letterSpacing !== 0 || align === JUSTIFY)) {
	            ...
	            if (letterSpacing !== 0) {
	              context.setAttr('letterSpacing', "".concat(letterSpacing, "px"));
	            }
	            this._partialTextX = lineTranslateX;
	            this._partialTextY = translateY + lineTranslateY;
	          ...
	          if (fixedWidth && lineWidth > maxWidth) {
	            while (line.length > 0) {
	              ...
	              while (low < high) {
	                ...
	                var shouldConsiderEllipsis = shouldAddEllipsis && fixedHeight && currentHeightPx + lineHeightPx > maxHeightPx;
	                var effectiveWidth = shouldConsiderEllipsis ? substrWidth + additionalWidth : substrWidth;
	      ...
	      value: function _useBufferCanvas() {
	        var hasLine = this.textDecoration().indexOf('underline') !== -1 || this.textDecoration().indexOf('line-through') !== -1;
	        var hasShadow = this.hasShadow();
	...
	PlayheadLayer.prototype._start = function () {
	  ...
	  self._playheadLineAnimation = new AnimationExports.Animation(function () {
	    var time = self._player.getCurrentTime();
