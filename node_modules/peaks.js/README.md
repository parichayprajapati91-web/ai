[![Build Status](https://ci.codeberg.org/api/badges/15097/status.svg)](https://ci.codeberg.org/repos/15097) [![npm](https://img.shields.io/npm/v/peaks.js.svg)](https://www.npmjs.com/package/peaks.js)

<p align="center">
  <a href="https://codeberg.org/chrisn/peaks.js"><img src="peaks-logo.svg" alt="Peaks.js" height="120" /></a>
</p>
...
<p align="center">
  <img src="peaks.png" alt="Peaks.js example" width="1034" height="402" />
</p>
...
Note that Peaks.js uses [Konva](https://konvajs.org/) and [waveform-data](https://codeberg.org/chrisn/waveform-data.js) as peer dependencies, so you must also install those modules.
...
* Pre-compute the waveform data from the audio, using [audiowaveform](https://codeberg.org/chrisn/audiowaveform), and provide the data to Peaks.js from your web server
...
Peaks.js uses waveform data files produced by [audiowaveform](https://codeberg.org/chrisn/audiowaveform). These can be generated in either binary (.dat) or JSON format. Binary format is preferred because of the smaller file size (including after gzip or Brotli compression).
...
Refer to the audiowaveform [documentation](https://codeberg.org/chrisn/bbc/audiowaveform) for full details of the available command line options, or use the manual page:
...
If you're having difficulty, please refer to the [Frequently Asked Questions](doc/faq.md) page or raise an [issue](https://codeberg.org/chrisn/peaks.js/issues).
...
```bash
git clone git@codeberg.org:chrisn/peaks.js.git
cd peaks.js
npm install
npm start
```
...
* [React](https://codeberg.org/chrisn/peaksjs-react-example)
* [Angular](https://codeberg.org/chrisn/peaksjs-angular-example)
...
If you'd like to contribute to Peaks.js, please take a look at the [contributor guidelines](CONTRIBUTING.md).
...
- [Thomas Parisot](https://github.com/thom4parisot)
- [Chris Needham](https://chrisneedham.com/about)

Thank you to all [contributors](https://codeberg.org/chrisn/peaks.js/activity/contributors).
